...
// must support. See specs/001-core-interfaces-data-model/spec.md FR-001
// through FR-011.
//
...
// callers; tests/contract/document-index.contract.ts is the executable
// proof of that, run first against an in-memory fake (milestone 001) and
// later against SqliteDocumentIndex (milestone 003).

import type { Chunk, Document, RankedChunk, Source, SourceType } from './types.js';
